...
#LSTM
filepath="/Users/jayavardhanreddy/Study_Slides/Second_Semester/5249_Inter-DB/Experiments/lm_vs_normal/LSTM_experiments.txt"
...
#CNN
filepath="/Users/jayavardhanreddy/Study_Slides/Second_Semester/5249_Inter-DB/Experiments/lm_vs_normal/CNN_experiments.txt"
...
#Language Model LSTM
filepath = "/Users/jayavardhanreddy/Study_Slides/Second_Semester/5249_Inter-DB/Experiments/lm_vs_normal/Language_Model_LSTM.txt"
...
#Language Model CNN
filepath = "/Users/jayavardhanreddy/Study_Slides/Second_Semester/5249_Inter-DB/Experiments/lm_vs_normal/Language_Model_CNN.txt"
...
print(np.var(lstmTestF1),np.mean(lstmTestF1),np.max(lstmTestF1))
print(np.var(lmLstmTestF1),np.mean(lmLstmTestF1),np.max(lmLstmTestF1))
print(np.var(cnnTestF1),np.mean(cnnTestF1),np.max(cnnTestF1))
print(np.var(lmCnnTestF1),np.mean(lmCnnTestF1),np.max(lmCnnTestF1))
